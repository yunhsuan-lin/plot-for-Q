...
data_T <- read.delim("clipboard", row.names = 1)

plor_for_Q (Reference_gene = "AT5G66940",
            Target_gene = "FT",
            y_axis = expression (paste ("Gene expression ratio ", "(", italic ("FT"), "/", italic ("AT5G66940"), ")")),
            line1 = "Col-0",
            line2 = "nrt1.13",
            save1 = "C:\\Users\\yun\\Desktop\\R ECO")